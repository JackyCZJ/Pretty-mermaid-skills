...
export function flattenSvg(svg, colors) {
  ...
  const computed = {
    ...
    '--surface': surface,
    '--border': border,
    // Use SVG-provided derived variables if available, otherwise compute
    '--_text': effectiveVars['--_text'] || fg,
    '--_text-sec': effectiveVars['--_text-sec'] || effectiveVars['--_text-secondary'] || muted,
    '--_text-muted': effectiveVars['--_text-muted'] || muted,
    '--_text-faint': effectiveVars['--_text-faint'] || mixColors(fg, bg, 0.25),
    '--_line': effectiveVars['--_line'] || line,
    '--_arrow': effectiveVars['--_arrow'] || accent,
    '--_node-fill': effectiveVars['--_node-fill'] || surface,
    '--_node-stroke': effectiveVars['--_node-stroke'] || border,
    '--_group-fill': effectiveVars['--_group-fill'] || bg,
    '--_group-hdr': effectiveVars['--_group-hdr'] || mixColors(fg, bg, 0.05),
    '--_inner-stroke': effectiveVars['--_inner-stroke'] || mixColors(fg, bg, 0.12),
    '--_key-badge': effectiveVars['--_key-badge'] || mixColors(fg, bg, 0.1),
  };
